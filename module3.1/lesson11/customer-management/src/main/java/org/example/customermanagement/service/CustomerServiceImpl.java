...
public class CustomerServiceImpl implements CustomerService {
    ...
    static {
        ...
        customers.put(4, new Customer(4, "Adam", "adam@codegym.vn", "Can Tho"));
        customers.put(5, new Customer(5, "Jane", "jane@codegym.vn", "Miami"));
        customers.put(6, new Customer(6, "Tom", "tom@codegym.vn", "TP.HCM"));
    }
    @Override
